...
DEEP WALK 2026-08-11 — INFOMAJA (1996 12 13 - Infomaja) | 20 images processed (19 PHOTO_OF_ORIGINAL, 1 SCREENSHOT). KEY DISCOVERIES: (1) MOTOR TOTEM from Bremen performed FIRE/PYRO installations in snow with humanoid robot, protective suits, and symbolic figurines — documented in Foto/ (IMG_6601-6604). (2) OP1 = MOTOR TOTEM confirmed via schedule/manifest (IMG_6596) listing 'OP1' 45min performance alongside Virus, Trimigi, Cukt. (3) TRIMIGI listed separately from OP1 in schedule — possibly Polish variant or separate act. (4) VIRUS listed as performer in program. (5) Infomaja teczka folder (01.jpg) shows seal + handwritten 'INFOMAJA — KULTURA TECHNICZNA LAT 90' with Warsaw address Tomaszowska 17/9. (6) Technical audio schematic (IMG_6598) shows multi-channel audio distribution: RADIO/CB-TAXI/CB-CUKT/TUBY inputs to MIKSER AUDIO, distributed to GALERIA/PIWNICA/PIĘTRO with outputs CB TAXI/CB CUKT/RADIO/MAPA/KOMENTARZ/SKANOWANIE. (7) Financial ledger (IMG_6593) lists payments: JANEK HOZA + 2 (TRY MIGI) 360zł, Neurobot, CUKT-3, various artists totaling 4000zł. (8) SERVISCO waybills (IMG_6600, IMG_6592) show shipments Gdynia→Gdańsk, Piotr Wyrzykowski recipient. (9) Letter to Tobias Lange (IMG_6594) discusses 'crazy machines' visit January/February 1996. (10) Flyer (IMG_6590, IMG_6591) confirms venue: Dawny Dom Kultury Kolejarza, Tołem ul. 1 Maja 3, November 13 1996, 18:00, VIDEO+PERFORMANCE+PARTY. DISK-ONLY: IMG_6592.jpg present on disk not returned by archive_get_images (Variant B). ALL 20 IMAGES HAVE DESCRIPTIONS. OPEN QUESTIONS: 38 existing in DB.
